...
This bot is currently under development, and errors may occur. If you encounter any issues, please reach out to us via our [Discord Server](https://discord.gg/nbs2ekQ83G) for assistance.
...
- Real-time notifications for *Welcome to Bloxburg* updates, keeping you informed effortlessly.
- Beautifully crafted *graphical charts* for user, game, and group information, all presented in an appealing image format.
